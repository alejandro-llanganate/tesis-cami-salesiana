...
// CALIDAD — 10 criterios del documento Word
...
async function cargarOrdenesCalidad() {
    ...
    renderizarOrdenesCalidad();
}

function renderizarOrdenesCalidad() {
    var t = document.getElementById("tablaOrdenesCalidad");
    t.innerHTML = "";
    ordenesCalidad.forEach(function(o) {
        var f = t.insertRow();
...
function iniciarInspeccion(ordenId) {
    ...
    window.scrollTo(0, document.getElementById("seccionInspeccion").offsetTop);
}
